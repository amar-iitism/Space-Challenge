...
public class Main {
    public static void main(String[] args) throws FileNotFoundException{
        ...
        System.out.println("=====Simulating Phase 1=====Simulating Phas1=====Simulating Phase1=====");
        ...
        System.out.println("========Simulating Phase1=======Simulating Phase 1=======Simulating Phase 1========");
        ...
        System.out.println("\nTotal budget needed for U1 rockets is: "+u2Cost);
        System.out.println("Total budget for U2 rockets is: "+u2Cost);
        if(u1Cost > u2Cost)
        {
